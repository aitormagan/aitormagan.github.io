...
# Personal Projects
* **[Home Away Controller](https://github.com/aitormagan/home_away_controller)**<br/>Enabling or disabling some smart accesories automatically when you are at home or away is something that some systems do based on the position of your mobile phone, altough it can reduce how much its battery lasts. This software is born from this necessity but with battery in mind: user location is detected by checking if the mobile phone is connected to your WiFi router and activate or deactivate the devices based on a configuration file. Extension is a main goal on this project allowing developers to create extensions to connect to different routers or smart devices by simply extending a class.<br/>*Jan, 2023*
